...
to use the web3 application you simply input any name for the sender and reciever as well as an amount. Then you hit add block, and from there you can see and select it on the side bar, and validate it on the bottom by pressing validate chain on the bottom.